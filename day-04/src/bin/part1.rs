...
mod tests {
    ...
    fn test_get_line_total() {
        assert_eq!(get_line_total((vec![41, 48, 83, 86, 17], vec![83, 86, 6, 31, 17, 9, 48, 53])), 8);
        assert_eq!(get_line_total((vec![13, 32, 20, 16, 61], vec![61, 30, 68, 82, 17, 32, 24, 19])), 2);
    }
